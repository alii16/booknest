...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="bg-white rounded-xl shadow-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Perbarui data pengguna {{ $user->name }}</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-gray-600 mt-1">Lengkapi data pengguna yang ingin diperbarui</p>
        </div>
        
        <form method="POST" action="{{ route('pustakawan.users.update', $user) }}" class="p-6 space-y-6">
            @csrf
            @method('PUT')
